...
class VKBot:
    ...
    def __init__(self):
        self.token = settings.token_vkinder
    ...
    def current_keyboard():
        ...
        keyboard.add_line()
        keyboard.add_button('Add to favourites', color=VkKeyboardColor.POSITIVE)
        keyboard.add_button('No, thank you', color=VkKeyboardColor.NEGATIVE)
        keyboard.add_line()
        keyboard.add_button('Favourites list', color=VkKeyboardColor.SECONDARY)
